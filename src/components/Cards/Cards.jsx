            ...
            <div className={styles.container}>
                <Grid container spacing={2} justify="center">
                    <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.infected)}>
                        <CardContent>
                            <Typography variant = "h5" color = "textPrimary" gutterBottom>Infectados Teste 3</Typography>
                    ...
                    <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.recovered)}>
                        <CardContent>
                            <Typography variant = "h5" color = "textPrimary" gutterBottom>Recuperados Teste 3</Typography>
                            <Typography variant = "h5">
                    ...
                    <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.deaths)}>
                        <CardContent>
                            <Typography variant = "h5" color = "secondary" gutterBottom> Mortes Teste 3</Typography>
                            <Typography variant = "h5">
